...
TSMS_LP TSMS_LIST_create(TSMS_SIZE initSize) {
	TSMS_LP list = TSMS_malloc(sizeof(struct TSMS_LIST));
	if (list == TSMS_NULL)
		return TSMS_NULL;
	list->list = TSMS_malloc(initSize * sizeof(void *));
...
TSMS_CLP TSMS_CHAR_LIST_create(TSMS_SIZE initSize) {
	TSMS_CLP list = TSMS_malloc(sizeof(struct TSMS_CHAR_LIST));
	if (list == TSMS_NULL)
		return TSMS_NULL;
	list->list = TSMS_malloc(initSize * sizeof(char));
	if (list->list == TSMS_NULL) {
...
TSMS_ILP TSMS_INT_LIST_create(TSMS_SIZE initSize) {
	TSMS_ILP list = TSMS_malloc(sizeof(struct TSMS_INT_LIST));
	if (list == TSMS_NULL)
		return TSMS_NULL;
	list->list = TSMS_malloc(initSize * sizeof(int));
	if (list->list == TSMS_NULL) {
...
TSMS_LLP TSMS_LONG_LIST_create(TSMS_SIZE initSize) {
	TSMS_LLP list = TSMS_malloc(sizeof(struct TSMS_LONG_LIST));
	if (list == TSMS_NULL)
		return TSMS_NULL;
	list->list = TSMS_malloc(initSize * sizeof(long));
	if (list->list == TSMS_NULL) {
...
TSMS_FLP TSMS_FLOAT_LIST_create(TSMS_SIZE initSize) {
	TSMS_FLP list = TSMS_malloc(sizeof(struct TSMS_FLOAT_LIST));
	if (list == TSMS_NULL)
		return TSMS_NULL;
	list->list = TSMS_malloc(initSize * sizeof(float));
	if (list->list == TSMS_NULL) {
