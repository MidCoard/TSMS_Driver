...
typedef enum {
	TSMS_TYPE_INT = 0, TSMS_TYPE_FLOAT, TSMS_TYPE_STRING, TSMS_TYPE_CHAR, TSMS_TYPE_BOOL, TSMS_TYPE_DOUBLE, TSMS_TYPE_LONG, TSMS_TYPE_SHORT, TSMS_TYPE_BYTE, TSMS_TYPE_OBJECT,
