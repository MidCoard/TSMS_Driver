...
typedef enum {
	TSMS_GPIO_OUTPUT_OPEN_DRAIN, TSMS_GPIO_OUTPUT_OD, TSMS_GPIO_OUTPUT_PULL_PUSH, TSMS_GPIO_OUTPUT_PP, TSMS_GPIO_INPUT, TSMS_GPIO_IT_RISING, TSMS_GPIO_IT_FALLING, TSMS_GPIO_IT_RISING_FALLING
} TSMS_GPIO_MODE;
