...
void AD9834_initHardware(GPIO_TypeDef *_SCLK, uint16_t _SCLK_PIN, GPIO_TypeDef *_SDA, uint16_t _SDA_PIN,
                         GPIO_TypeDef *_FSYNC, uint16_t _FSYNC_PIN, GPIO_TypeDef *_FS, uint16_t _FS_PIN,
                         GPIO_TypeDef *_PS, uint16_t _PS_PIN, GPIO_TypeDef *_RST, uint16_t _RST_PIN,
                         GPIO_TypeDef *_SLEEP, uint16_t _SLEEP_PIN, uint16_t pin_sw_bit);
