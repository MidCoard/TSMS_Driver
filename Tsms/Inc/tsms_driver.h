...
typedef enum {
	TSMS_DRIVER_TYPE_SPI, TSMS_DRIVER_TYPE_IIC, TSMS_DRIVER_TYPE_CUSTOM
} TSMS_DRIVER_TYPE;
...
typedef TSMS_RESULT(*TSMS_DRIVER_IIC_WRITER)(TSMS_IHP, uint32_t , TSMS_BITS, uint32_t, TSMS_BITS);
typedef TSMS_RESULT(*TSMS_DRIVER_IIC_READER)(TSMS_IHP, uint32_t , TSMS_BITS, uint32_t *, TSMS_BITS);
