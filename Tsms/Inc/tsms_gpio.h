...
typedef enum {
	TSMS_GPIO_STATUS_LOW = 0, TSMS_GPIO_STATUS_HIGH = 1, TSMS_GPIO_STATUS_ERROR
} TSMS_GPIO_STATUS;
...
typedef enum {
	...
	TSMS_GPIO_MODE_INPUT = 2,
	TSMS_GPIO_MODE_IT_RISING = 4, TSMS_GPIO_MODE_IT_FALLING = 8, TSMS_GPIO_IT_MODE_RISING_FALLING = 16
} TSMS_GPIO_MODE;
